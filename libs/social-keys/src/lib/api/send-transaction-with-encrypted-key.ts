import { sendTransactionWithLitAction } from '../lit-actions-client'
import { getLitActionCid } from '../lit-actions-client/utils'
import { fetchPrivateKey } from '../service-client'
import { SendTransactionWithEncryptedKeyParams } from '../types'
 ...
 *
 * @param { SendTransactionWithEncryptedKeyParams } params Parameters required to sign the requested transaction
 *
 ...
 */
export async function sendTransactionWithEncryptedKey(
  params: SendTransactionWithEncryptedKeyParams,
): Promise<string> {
