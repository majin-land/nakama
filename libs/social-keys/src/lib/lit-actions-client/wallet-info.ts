...
interface WalletInfoWithLitActionParams {
...
const litActionCode = fs.readFileSync('./apps/lit-action/dist/wallet-info.js', 'utf8')

export async function walletInfoWithLitAction(args: WalletInfoWithLitActionParams) {
  const {
