...
const manifest = [{"module":"@nakama/social-keys","exactMatch":"libs/social-keys/src/index.js","pattern":"libs/social-keys/src/index.ts"}];
...
module.exports = require('./apps/relay-bot/src/main.js');
